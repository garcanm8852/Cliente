...
<body>
    ...
    $sentencia = "call eliminarAlumnos()";
    ...
    */
     ...
     * 
     */
    $registros = mysqli_query($conexion, $select) or
    ...
    if ($reg = mysqli_fetch_array($registros)) {
        ...
        echo "Se han eliminado todos los registros de la tabla " . $tabla;
    } else {
        echo "La tabla que desea borrar está vacía.";
    }
